...
licks = [2639 0 0 267 357 1436];
cons = [0.08 1.1756 2.325 1.317 1.423 0.947];
...
for i = 1:numel(rats)
    ...
    if row == find(ratsInfo.ratID == rats(i)) & col == days(i)
        RAP_totalLicks(row, col) = 0; RAP_all{row, col} = 0;
    else 
        warning("Location of outlier data isn't matching day and rat number")
    end 
end 
