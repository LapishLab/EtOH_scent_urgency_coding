function [data] = fixRAPMedPCFile(data)
...
eighteen_sixteen{1}.A = eighteen{1}.A;
%Replace E (List of Left lick times in seconds)
eighteen_sixteen{1}.E = eighteen{1}.E;
%Replace the left three positions in J (list of beam state
%transition counters) 
eighteen_sixteen{1}.J(1:3) = eighteen{1}.J(1:3);
%Replace P (Beam 1 Breaks), Q (Beam 2 Breaks), and R (Beam 3
%Breaks)
eighteen_sixteen{1}.P = eighteen{1}.P;
eighteen_sixteen{1}.Q = eighteen{1}.Q;
eighteen_sixteen{1}.R = eighteen{1}.R;
