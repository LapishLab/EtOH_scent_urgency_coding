...
group = ratsInfo.treatment == "EtOH"; %determine which animals you want to look at. Probably ethanol or water consumers 
Dataset = consumptionOverTime{3}(group, :)'; %call your data matrix here. Individual subjects on columns, data (not cumulative) over time on rows
Dir = 'C:\Users\annar\OneDrive\Documents\IUSM\Dr. Lapish Lab\EtOH_scent_Urgency\graphs\frontloading\day3'; %enter the name of the folder where you want your results to be saved. Must be a char vector, not a string
